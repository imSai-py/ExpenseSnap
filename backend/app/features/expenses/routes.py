...
def index():
    ...
    return render_template(
        ...
        total=summary.total_balance,  # Note: summary object has Attributes total_balance, etc.
...
def set_currency():
    ...
    return redirect(url_for('expenses.profile'))  # Redirect to profile now


@expenses.route('/add-expense', methods=['GET', 'POST'])
@login_required
def add_expense_page():
    """Render and handle the Add Expense page."""
    form = ExpenseForm()
    ...
    return render_template('add_expense.html', form=form, currency_symbols=ExpenseService.get_currency_symbols())


@expenses.route('/statistics')
@login_required
def statistics():
